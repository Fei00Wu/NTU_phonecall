...
diarization/nnet3/xvector/score_plda.sh --cmd "run.pl"\
 --target-energy 0.9 --nj 1 $nnet_dir/xvectors_dihard_2018_dev/\
...
rm -rf $outputdir
mv -v $datadir/diarization_result $outputdir
rm -rf $datadir
...
do
  ...
  #echo $file_name_fist,$file_name,$starting_timeline,$ending_timeline,$speaker_id
